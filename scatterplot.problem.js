function scatter_plot(data,
    ...
    // Corrected legend interactivity
    legends_items.on("click", function (event, d) {
        ...
        d3.selectAll("circle")
            .classed("selected", c => selectedCountries.includes(c[colorCol])) // Highlight selected points
            .classed("dimmed", c => selectedCountries.length > 0 && !selectedCountries.includes(c[colorCol])); // Dim unselected points
    });
}
